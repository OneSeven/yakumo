    ...
    webFontLoader: function () {
        WebFontConfig = {
            ...
            custom: {
                ...
                urls: ["/usr/themes/yakumo/css/font.min.css"]
            }
        },
            loadJS("/usr/themes/yakumo/js/webfont.js",
                function () {
                    WebFont.load({
                        custom: {
                            families: ["Exo", "iconfont"]
                    ...
                    e.one("appear",
                        function () {
                            if (!this.loaded) {
                                ...
                                var o = e.attr("data-" + i.data_attribute); (o.indexOf("bayun.org") > -1) && (1 == i.advanced_load && (o += "!"), 1 == i.webP_load && (o += "/format/webp"), 1 != i.webP_load && (o += "/format/jpg"), 1 == i.is_scale && (o += "/fw/" + i.scale_width)),
                                    $("<img />").bind("load",
                                        function () {
                                            e.hide(),
